...
//            return
//        }
        ASPINRemoteImageDownloader.shared().cachedImage(with: URL(string: photoURL)!, callbackQueue: DispatchQueue.main) { [weak self] cache in
            self?.underlyingImage = cache?.asdk_image()
        }
